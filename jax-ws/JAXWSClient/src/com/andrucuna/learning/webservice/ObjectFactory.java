 ...
 * generated in the com.andrucuna.learning.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorldResponse_QNAME = new QName("http://webservice.learning.andrucuna.com/", "helloWorldResponse");
    private final static QName _HelloWorld_QNAME = new QName("http://webservice.learning.andrucuna.com/", "helloWorld");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.andrucuna.learning.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.learning.andrucuna.com/", name = "helloWorldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.learning.andrucuna.com/", name = "helloWorld")
