 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://endpoint.helloservice/", wsdlLocation = "http://localhost:8080/helloservice/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://endpoint.helloservice/", "HelloService");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://endpoint.helloservice/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://endpoint.helloservice/", "HelloPort"), Hello.class, features);
    }
